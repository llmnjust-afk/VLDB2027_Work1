...
Batch dynamic $k$-core hierarchies were studied by Gabert et al.~\cite{gabert2022batch}, order-based sequential core maintenance by Guo and Sekerinski~\cite{guo2022parallel}, bipartite core maintenance by Luo et al.~\cite{luo2023efficient}, differentially private variants by Dhulipala et al.~\cite{dhulipala2023nearoptimal}, and hypergraph cores by Arafat et al.~\cite{arafat2023neighborhoodbased}.
...
Recent work extends the decomposition itself: Chen et al.~\cite{chen2021higherorder} generalize trusses to higher-order clique structures with a TKDE journal treatment, Chen et al.~\cite{chen2024parallel} parallelize higher-order truss decomposition, Chand et al.~\cite{chand2024agentbased} unlock truss computation through mobile-agent triangle counting, and Shi et al.~\cite{shi2023parallel} situate trusses inside parallel nucleus decompositions.
